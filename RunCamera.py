...
cities = ['Delhi', 'Mumbai', 'Kolkata', 'Chennai', 'Hyderabad', 'Banglore', 'Noida', 'Pune',
         'sAhmedabad', 'Goa', 'Cochi', 'Lucknow', 'Ludhiana', 'Chandigarh', 'Bhubaneswar',
          'Ranchi', 'Raipur', 'Shillong', 'Patna', 'Nagpur', 'Kanpur', 'Srinagar',
          'Vijayawada', 'Visakhapatnam', 'Tirupati', 'Coimbattor', 'Trivandrum',
          'Bhopal', 'Jaipur', 'Dehradun', 'Pilani', 'Kharagpur', 'Ropar', 'Darjelling']
...
class Client(QWidget):
    def __init__(self, port=MASTERPORT, ip=MASTERIP):
        ...
        self.setWindowTitle('Saviour - Camera Node')
